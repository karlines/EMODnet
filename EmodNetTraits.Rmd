...
The fraction of data for which individual weight could be estimated = `r nrow(DensityWeight$complete)/nrow(occ.full)`
...
The fraction of data for which traits could be estimated = `r nrow(DensityTrait$complete)/nrow(occ.full)`
...
The fraction of data for which feeding types could be estimated = `r nrow(DensityFT$complete)/nrow(occ.full)`
